...
Item {
    ...
    Image {
        width: 30*dp
        height: 30*dp
        source: dp <= 1 ? (node.focused ? "qrc:/images/node_rect_red.png" : "qrc:/images/node_rect_gold.png")
                        : (node.focused ? "qrc:/images/node_rect_red@2x.png" : "qrc:/images/node_rect_gold@2x.png")
    }
